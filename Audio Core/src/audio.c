...
void LineinLineoutConfig() {
	...
	AudioWriteToReg(R17_CONVERTER_CONTROL_0, 0x01);//48 KHz
	AudioWriteToReg(R64_SERIAL_PORT_SAMPLING_RATE, 0x01);//48 KHz
	...
	AudioWriteToReg(R5_RECORD_MIXER_LEFT_CONTROL_1, 0x01);  // Boost Left Gain to +12dB
	AudioWriteToReg(R6_RECORD_MIXER_RIGHT_CONTROL_0, 0x01);
	AudioWriteToReg(R7_RECORD_MIXER_RIGHT_CONTROL_1, 0x01); // Boost Right Gain to +12dB
