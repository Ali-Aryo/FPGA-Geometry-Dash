...
/* Slave address for the ADAU audio controller (I2C) */
#define IIC_SLAVE_ADDR			0x76

/* I2C Serial Clock frequency in Hertz */
#define IIC_SCLK_RATE			400000

/* * ADAU1761 Internal Control Registers
 * These are used via I2C to configure power, volume, and routing.
 */
enum audio_regs {
...
/* * Audio Controller Data Registers (I2S)
 * These are used by the CPU to send/receive actual audio samples.
 */
enum i2s_regs {
...
/* Hardware Setup Functions (defined in audio.c) */
